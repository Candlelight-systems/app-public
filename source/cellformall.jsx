...
function render( data ) {
	...
	ReactDOM.render(
	<CellFormAll allStatuses={ data.allStatuses } channelIds={ data.channelIds } formState={ data.cellData } photodiodeRefs={ data.photodiodeRefs } onValidate={ onValidate } onClose={ onClose } />,
