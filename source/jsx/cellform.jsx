            ...
            <div className="tab-pane active" id={'cell_' + this.state.unique}>
                ...
                <div className="col-sm-9">
                  ...
                  {active ? (
                    <div className="help-block">
                      The device name cannot be changed once the device is in
                      active mode
                    </div>
                  ) : null}
                </div>
              ...
              <div className="form-group">
                ...
                <div className="col-sm-9">
                  ...
                  {active ? (
                    <div className="help-block">
                      The area cannot be changed once the device is in active
                      mode
                    </div>
                  ) : null}
                </div>
                    ...
                    <div className="radio">
                      <label>
                        ...
                        <input
                          ...
                          onChange={this.handleInputChange}
                          value={this.state.correctionFactor_value}
                        />
                      </label>
                    </div>

                    <div className="help-block">
                      Correction factor to the sun intensity. Use it to account
                      for the geometrical uniformity of the light source, such
                      as the edge effects. The correction goes as effective_sun
                      = measured_sun / correction_factor.
                    </div>
                  </div>
                </div>
              ) : null}
