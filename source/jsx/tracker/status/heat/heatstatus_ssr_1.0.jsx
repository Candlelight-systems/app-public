...
class HeatStatus extends React.Component {
  ...
  setPIDParameters() {
    ...
    try {
       fetch( urllib.formatUrl( `http://${ this.props.config.trackerHost }:${ this.props.config.trackerPort}/heat.setPIDParameters`, {
      ...
      } ) ).then( response => { if( response.status !== 200 ) { throw "Error" } } );
  ...
  setPower() {
    ...
    try {
       fetch( urllib.formatUrl( `http://${ this.props.config.trackerHost }:${ this.props.config.trackerPort}/heat.setPower`, {
    ...
    if( this.buttonHeatCool && this.buttonMode && ! this.transformed ) {
      ...
      $( this.buttonMode ).bootstrapToggle({
        ...
        fetch( `http://${ this.props.config.trackerHost }:${ this.props.config.trackerPort }/heat.setMode?mode=${ this.buttonMode.checked ? 'pid' : 'fixedPower'}&instrumentId=${ this.props.instrumentId }&groupName=${ this.props.name }` , {
          ...
          ipcRenderer.send("reportError", "Unable to change the heating mode" );
            ...
            <div>
              ...
              <div className="row">
                ...
                <div className="col-lg-4">
                  ...
                  <label>
                    <input data-toggle="toggle" type="checkbox" ref={ ( el ) => this.buttonHeatCool = el }  checked={ this.state.heater_cooling } data-width="100" data-height="25" />
                  </label>
                </div>
              </div>
               ...
               <div className="row">
                ...
                <div className="col-lg-4">
                  ...
                  <label>
                    <input data-toggle="toggle" type="checkbox" ref={ ( el ) => this.buttonMode = el }  checked={ this.state.heater_mode == 'pid' } data-width="100" data-height="25" />
                  </label>
                </div>
              </div>
              ...
              { this.state.heater_mode == 'pid' ?
                ...
                <div>
                  ...
                  { this.state.pid_error && <div className="alert alert-danger">Error in setting the PID parameters.</div> }
                  { this.state.pid_success && <div className="alert alert-success">PID parameters updated !</div> }
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">{ this.state.heater_target_temperature ? this.state.heater_target_temperature + " °C" : 'N/A' }</div>
                    </div>
                      ...
                      <div className="col-lg-3">
                          <div className="input-group input-group-sm">
                            ...
                            <span className="input-group-btn">
                              <button className="btn btn-default" onClick={ this.setTargetTemperature } type="button">Set</button>
                            </span>
                          </div>
                      </div>
                    ...
                    <div> 
                      <div className="row">
                        ...
                        <div className="col-lg-4">
                          <small><em>Duty cycle (0.0 - 1.0) </em></small>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-lg-5">
                        ...
                        <div className="col-lg-4">
                          <small><em>Temperature error in °C</em></small>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-lg-5">
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                          <input className="form-control input-sm" name="Kp" value={ this.state.heater_cooling ? this.state.Kp_cooling : this.state.Kp_heating } onChange={ this.handleInputChange } />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                          <input className="form-control input-sm" name="Kd" value={ this.state.heater_cooling ? this.state.Kd_cooling : this.state.Kd_heating } onChange={ this.handleInputChange } />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                          <input className="form-control input-sm" name="Ki" value={ this.state.heater_cooling ? this.state.Ki_cooling : this.state.Ki_heating } onChange={ this.handleInputChange } />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4">
                          <input className="form-control input-sm" name="bias" value={ this.state.heater_cooling ? this.state.bias_cooling : this.state.bias_heating } onChange={ this.handleInputChange } />
                      </div>
                    </div>

                    <div className="row">
                      <div className="col-lg-5"></div>
                      <div className="col-lg-4"><button className="btn btn-default btn-sm" onClick={ this.setPIDParameters } type="button">Update PID parameters</button></div>
                    </div>
              ...
              :
                ...
                <div>
                 <h5>Fixed power</h5>
                  { this.state.power_error && <div className="alert alert-danger">Error in setting the powers.</div> }
                  { this.state.power_success && <div className="alert alert-success">Power updated !</div> }
                  ...
                  <div> 
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-3 input-group input-group-sm">
                          <input className="form-control" type="number" name="newpower" value={ this.state.newpower } onChange={ this.handleInputChange } />
                          <span className="input-group-addon">
                            %
                          </span>
                          <span className="input-group-btn">
                            <button className="btn btn-default" onClick={ this.setPower } type="button">Set</button>
                          </span>
                      </div>
                    </div>
                </div>
