...
export const autoZero = ( urlProps, instrumentId, chanId ) => {
	return fetchGET( urllib.formatUrl( `${ buildURL( urlProps ) }instrument.autoZero`, {
...
export const getChannelStatus = ( urlProps, instrumentId, chanId ) => {
	return fetchGETJson( urllib.formatUrl( `${ buildURL( urlProps ) }getStatus`, {
		instrumentId: instrumentId,
		chanId: chanId 
	} ) );
}
...
export const resetChannelStatus = ( urlProps, instrumentId, chanId ) => {
	...
	return fetchGET( urllib.formatUrl( `${ buildURL( urlProps ) }resetStatus`, { 
		instrumentId: instrumentId,
		chanId: chanId 
	} ) );
}
...
export const channelExecuteIV = ( urlProps, instrumentId, chanId ) => {
	...
	return fetchGET( urllib.formatUrl( `${ buildURL( urlProps ) }executeIV`, {
		instrumentId:  instrumentId,
		chanId: chanId 
	} ) );
}
...
export const channelExecuteVoc = ( urlProps, instrumentId, chanId ) => {
	...
	return fetchGET( urllib.formatUrl( `${ buildURL( urlProps ) }recordVoc`, {
		instrumentId:  instrumentId,
		chanId: chanId 
	} ) );
}
...
export const channelExecuteJsc = ( urlProps, instrumentId, chanId ) => {
	...
	return fetchGET( urllib.formatUrl( `${ buildURL( urlProps ) }recordJsc`, {
		instrumentId:  instrumentId,
		chanId: chanId 
	} ) );
}