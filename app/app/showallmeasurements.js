...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jsx_error_jsx__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__jsx_influx__ = __webpack_require__(48);
...
class AppForm extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	...
	async verifyConfig() {
		...
		try {
			...
			const auth = await __WEBPACK_IMPORTED_MODULE_2_node_fetch___default()(query_auth).then(response => response.json());
			...
			try {
				...
				const dbs = await __WEBPACK_IMPORTED_MODULE_2_node_fetch___default()(query_db).then(response => response.json());
