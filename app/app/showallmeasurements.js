...
var convert = __webpack_require__(21).convert;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jsx_influxform_jsx__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jsx_error_jsx__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__influx__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_electron__ = __webpack_require__(12);
	...
	dialog.showMessageBox({
		...
		if (index == 1) {
			...
			try {
				...
				await Object(__WEBPACK_IMPORTED_MODULE_4__influx__["d" /* query */])(`DROP MEASUREMENT ${measurementName};`, data.configDB.db, data.configDB);
				render();
			} catch (e) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_node_fetch__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_electron__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_util_fetch__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__influx__ = __webpack_require__(13);
...
const openDocs = () => {
	__WEBPACK_IMPORTED_MODULE_3_electron__["shell"].openExternal('https://docs.influxdata.com/influxdb/v1.5/query_language/authentication_and_authorization');
};
...
class AppForm extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
	...
	async createDB() {
		...
		try {
			const reply = await Object(__WEBPACK_IMPORTED_MODULE_4__app_util_fetch__["a" /* postJSON */])(address + `&q=${encodeURIComponent(`CREATE DATABASE "${db}"`)}`);

			const reply_privileges = await Object(__WEBPACK_IMPORTED_MODULE_4__app_util_fetch__["a" /* postJSON */])(address + `&q=${encodeURIComponent(`GRANT ALL ON "${db}" TO ${u}`)}`);
	...
	async verifyConfig() {
		...
		try {
			...
			await Object(__WEBPACK_IMPORTED_MODULE_5__influx__["c" /* ping */])(this.state);
			//	await fetch( query );
			state.db_connection = 'ok';

			try {
				const dbs = await Object(__WEBPACK_IMPORTED_MODULE_5__influx__["b" /* checkDB */])(this.state, u, p, db);
			...
			try {
				...
				await Object(__WEBPACK_IMPORTED_MODULE_5__influx__["a" /* checkAuth */])(this.state, u, p, db);
	...
	render() {
		...
		switch (this.state.db_dbexists) {
			...
			case 'ok':
				...
				status_text_db_dbexists = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'span',
					null,
					'Database exists'
				);
			...
			default:
				...
				status_text_db_dbexists = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					...
					__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
						'button',
						{ className: 'btn btn-default', onClick: this.createDB },
						'Create'
					)
				);
				break;
		...
		return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
			...
			status_text_db_auth && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				{ className: "alert " + status_class_db_auth },
				status_text_db_auth
			),
			status_text_db_dbexists && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				'div',
				{ className: "alert " + status_class_db_dbexists },
			...
			__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				...
				__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
					'button',
					{ type: 'button', className: 'btn btn-primary', name: 'update', onClick: this.verifyConfig },
...
var iconvLite = __webpack_require__(22);
...
var bomHandling = __webpack_require__(23),
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(5).concat(__webpack_require__(9)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(10).concat(__webpack_require__(38)) },
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = postJSON;
